...
Obtain the same decomposition manually using the algorithm described in notebook 04_D. Store all the results in different columns of a dataframe (tsibble) called `manual_dcmp1`
