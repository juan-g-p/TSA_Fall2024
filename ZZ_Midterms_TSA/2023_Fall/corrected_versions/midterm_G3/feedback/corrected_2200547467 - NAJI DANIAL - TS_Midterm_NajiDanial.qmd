...
In the autocorrelation of the log-transformed data, we can clearly see the trend component is strong. Whereas the plot done on the log_detrended, the plot show the seasonal component, and no trend component,as the trend component is deleted
...
FEEDBACK: very good. Still I remember you had not clearly identified m during the exam. Sleep more next time.
