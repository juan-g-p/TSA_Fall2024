...
**YOUR ANSWER GOES HERE (20 WORDS)** #The log transformation stabilizes variance, making trends more apparent, and it also reduces data fluctuations, which helps us in modeling and identifying underlying patterns ------------------------------------------------------------------------
...
FEEDBACK: WRONG WINDOWS SIZE AND WORNG LIBRARY USED.

THIS CODE WAS OBTAINED FORM A SOURCE OTHER THAN THE CLASS NOTES AND BOOK, WHICH WAS WHAT WAS AVAILABLE TO YOU AND WHAT YOU WERE SUPPOSSED TO USE.

YOU NEEDED A 2X12 MA AND USED A 7-MA

USE THE CODE AND TOOLS GIVEN IN CLASS.
...
FEEDBACK: VERY INCOMPLETE CODE THAT DOES NOT EVEN RUN
