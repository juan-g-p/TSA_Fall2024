...
I am not asking you to judge stationarity, we hade not seen this concept (fb)
...
fb class dcmp is constant. See notes
...
Good idea for comparison, yet they do not match
...
fb: code does not run

How curious, you have very similar code to some students... code that was not in the notes (fb )
