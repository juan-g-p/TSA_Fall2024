...
The log transformation renders a multiplicative scheme additive.
------------------------------------------------------------------------
...
FEEDBACK: DTRENDED WELL, PLOTTED WRONG.
...
FEEDBACK: you strt with a plot to compute the ACF?? makes no sense...
...
FEEDBACK: THIS WOULD HAVE WORKED IF YOU HAD USED INDEX_BY INSTEAD OF GROUP BY, OF IF YOU HAD CONVERTED TO A TSIBBLE
...
FEEDBACK: SAME FEEDBACK AS BEFORE
