...
FEEDBACK: a log transformation is used to turn multiplicative schemes into additive schemes
...
FEEDBACK: what I wanted you to say is that the classical seasonal component remains constant while STL changes overtime

------------------------------------------------------------------------

## 3.3 Compare the `trend_class` you previously computed with the trend returned by classical decomposition. Do they match? (answer this question with a single boolean TRUE or FALSE)

FEEDBACK: you were suppossed to use "all.equal... " as int he examples and the assignment
