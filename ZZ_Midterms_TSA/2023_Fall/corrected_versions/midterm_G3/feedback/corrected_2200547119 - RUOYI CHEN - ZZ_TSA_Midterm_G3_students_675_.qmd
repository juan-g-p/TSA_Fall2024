...
**YOUR ANSWER GOES HERE (20 WORDS)** I have some problem that everycode shows "log_value not found", I am nervous about this because I haven't learnt about R basic in my previous courses. But I still keep these structures, hoping it will not have too much bad impact on my evalutaion. ------------------------------------------------------------------------
...
FEEDBACK: repeat the exam until you are satisfied and understand everything.
...
NOT WHAT I was asking: I was asking to compare seasonal components: one is constant the other is not (fback)
