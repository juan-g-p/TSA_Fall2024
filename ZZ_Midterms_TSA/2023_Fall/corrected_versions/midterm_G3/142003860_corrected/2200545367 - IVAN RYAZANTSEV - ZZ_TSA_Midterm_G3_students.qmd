...
While the first plot shows a linear trend, the other shows significant cyclic fluctuations from one side to another (since we detrended the ts on the second graph)
------------------------------------------------------------------------
