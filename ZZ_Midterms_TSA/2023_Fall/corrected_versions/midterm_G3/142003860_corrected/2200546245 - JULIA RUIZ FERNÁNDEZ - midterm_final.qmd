...
The log transformation is a way to transform a multiplicative scheme into more addition type. It is 
one of the most powerful techniques to do this, after the inverse. It makes the size of the pattern not affected because of the trend.Therefore, the magnitude of the seasonal pattern observed remains similar regardless of the trend.
