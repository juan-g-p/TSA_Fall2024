...
the legnth of the seasonal period is of arounf 5 to 6 months and we can clearly see it in the detrended acf plot
...
The histogram (symmetric and with some outliers), QQ-plot, and Box-Plot (mean close to median 
 and symmetry) all seem to indicate that the normality assumption is fair.
 
 FEEDBACK, OK BUT YOU DID NOT CREATE BOX-PLOT AND QQPLOT!
 
 WHAT ABOUT AUTOCORRELATION!! THIS IS ONE OF THE MOST IMPORTANT THINGS
