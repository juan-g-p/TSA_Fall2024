...
FEEDBACK: YOU DETRENDED IN A MULTIPLICATIVE MANNER... BUT OK
...
FEEDEBACK: STOP DOING COPY PASTE... YOU ARE FITTING SO MANY MORE MODELS THAN I REQUESTED!!
...
When it comes to normality we can see how the data is approximately normal as the graph shows a more or less uniform distribution (FEEDBACK: THIS SENTENCE DOES NOT MAKE SENSE). From the graphs we can also see how the data is heterstatic, which will lead to problems with the forecasts.

FEEDBACK:

THE MOST IMPORTANT ASPECT IN A S MODEL IS AUTOCORRELATION.
