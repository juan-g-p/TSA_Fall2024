...
FEEDBACK: YOU DID NOT USE A MOVING AVERAGE. ALSO YOU DID AN STL INSTEAD O FA CLASSICAL DECOMP
...
classical_dcmp %>% ACF(unemp) %>% autoplot


classical_dcmp %>% ACF(detrended) %>% autoplot
...
We can see that the length of the seasonal period is 6 month in the detrended acf plot

WRONG PERIOD. SEE SOLUTION.
...
BASIC GRAPHS AND NO ANALYSIS. THIS IS NOTHING. SHOULD GIVE YOU 0 POINTS
...
FEEDBACK: NEED TO STUDY MORE AND COPY MORE INSTEAD OF DOING SOLELY COPY PASTE. YOU CAN COPY AND PASTE CODE BUT ADAPT IT WELL

ALSO YOU SEEM TO HAVE SOME BASIC CONCEPT PROBLEMS (SEASONAL PERIOD 6... AND SOME MORE STUFF.)