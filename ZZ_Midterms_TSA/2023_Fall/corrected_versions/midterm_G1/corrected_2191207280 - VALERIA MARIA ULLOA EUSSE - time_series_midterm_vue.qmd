...
FEEDBACK: YOU ARE SUPPOSSED TO USE MOVING AVERAGES....
...
FEEDBACK: I WAS NOT ASKING FOR THIS
...
feedback: CODE DOES NOT RUN AND IS NOT EVEN CORRECT
...
Since this is monthly data, this corresponds to yearly seasonality. 2 years.

FEEDBACK: THIS IS NONSENSE. YOU CAN HAVE MONTHLY DATA WITHOUT SEASONALITY.
...
FEEDBACK: YOU ARE USING DEFAULTS, NOT ADJUSTING ANYTHING
...
FEEDBACK: YOU FIT THE PROPER MODELS + SOME MORE AND THEN YOU FIT ANOTHER THING... THIS IS NONSENSE.. YOU DO NOT UNDERSTAND WHAT YOU ARE DOING. STOP SOLELY COPY PASTING AND UNDERSTAND.
...
fc %>%
  filter() %>%
  autoplot(unemp, level = 95, alpha = 0.6)
...
feedback most basic graph and NO ANALYSIS
