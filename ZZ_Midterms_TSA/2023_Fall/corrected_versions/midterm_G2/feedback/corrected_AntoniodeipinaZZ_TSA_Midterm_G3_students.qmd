...
log transform is better to work
...
In the AFC we can see the seasonal component, in the other not.

FEEDBACK: both are ACFs. This text makes no sense.
...
STL has more variance and seasonal component grows over time, the classical decomposition remains constant.

------------------------------------------------------------------------

## 3.3 Compare the `trend_class` you previously computed with the trend returned by classical decomposition. Do they match? (answer this question with a single boolean TRUE or FALSE)

FEEDBACK: YOU HAVE COPIED FROM IKER OR THE OTHER WAY AROUND. YOUR EXAMS ARE IDENTICAL.
