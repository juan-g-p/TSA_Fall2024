...
-   When answering the questions please **stick to the questions asked and respect the limit regarding the number of words** (use an online word counter or your text processor of choice).
...
4.  Create and interpret ACF plots and lag plots to identify the seasoanlity **(0.7 points)**
...
-   3.2.5 Do the differences in the stock prices look like white noise? **(0.45 points)**.
