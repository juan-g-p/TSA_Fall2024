...
Starting from `cali_fuel_y_m`, create a series of taining datasets for cross validation that fulfill:
...
**REMOVE** 1. Has best residuals in RMSE terms. Compute the average RMSE over all the forecast horizons. **REMOVE**
