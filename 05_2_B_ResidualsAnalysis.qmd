...
-   **NOTE:** in case of doubt, best judgement regarding homoskedasticity can be attained combining visual inspection with some form of statistical testing, but we will spare that for now.
...
Analyse the residuals of the decomposition model from exercise 1 in notebook 5_1. Below the code to fit the model we used to depict the data and fit the model:
